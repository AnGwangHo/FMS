	...
	<ul id=table><li class="alert alert-info" style="margin-bottom: 50px;">
		...
		<form method="POST" name="registForm" id="registForm" style="color: white;">
			...
			<li style="list-style: none; float:left; margin-left: 50px; margin-right: 50px;">
				...
				src="http://localhost/memberdisplayFile?fileName=${Member_info.member_profile_image}"/>
				...
				<!-- src="D:/kosta126/workspace/FMS/src/main/webapp/resources/images/member/${Member_info.member_profile_image}" -->
				<%-- <input type="file" id="member_profile_image" class="form-control" name="member_profile_image" style="width: 85%;" onchange="/html/images/member/${Member_info.member_profile_image}" on> --%>
			</li>
			...
			<ul style="margin-left: 140px;">
				...
				<li class="info" style="margin-bottom: 10px; margin-left: 210px;">
				...
				<li class="info" style="margin-left: 210px;"><label class="title_info" for="id_info"
...
/* ---------------------파일첨부 스크립트----------------------------- */
		   var member_num = ${Member_info.member_num};
		   console.log("멤버넘버"+${Member_info.member_num});
