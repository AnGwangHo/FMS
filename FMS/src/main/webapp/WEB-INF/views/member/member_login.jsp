...
<!-- 본문내용! -->
          ...
          <div class="contact-from row">
            <div class="col-md-12 col-lg-12">
              <div id="message"></div>
              <form method="post" align="center"action="member/member_loginPost" id="login"> 
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<a class="btn btn-default" data-dismiss="toggle"><span
												...
												<div class="modal-body">
													<h4 style="color: black">올바른 아이디와 비밀번호를 입력하세요</h4>
												</div>
												<div class="modal-footer">
													<div class="btn-group">
														<button class="btn btn-primary" onclick="$('#myModal').toggle('close')">
															<span class="glyphicon glyphicon-check"></span> 확인
														</button>
													</div>
												</div>
											</div>
...
<script type="text/javascript">
	$(function() {
		$("#login").submit(function() {
			...
			var passwd = $(this).find("input[name=\"member_passwd\"]").val();

			var params = "id=" + id + "&passwd=" + passwd;

			$.ajax({
				type : "post",
				data : params,
				url : "member/member_loginPost",
