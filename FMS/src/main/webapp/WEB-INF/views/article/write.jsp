            ...
            <div class="table-responsive">
                  ...
                  <table class="table table-bordered  table-hover ">
                     ...
                     <tr>
                        ...
                        <td><input type="text" class="form-control" name="member_num" placeholder="" disabled="disabled"></td>
                        ...
                        <td><div class="input-group">
                           ...
                           <input type="text" id="fake-file-input-name" disabled="disabled" placeholder="File not selected" class="form-control" name="bulletin_attachment">
                           <span class="input-group-btn">
                     ...
                     <tr>
                        <td colspan="4"><textarea rows="20" cols="178"
                              onfocus="javascript:this.value='';" name="bulletin_content">여기에 글을 입력하세요.</textarea></td>
                     </tr>
                  </table>
               ...
               <div align="right" style="margin-right: 10px">
                  ...
                  -->
                  <button type="submit" onclick="javascript:location.href='listAll'" class="btn btn-primary  btn3d">
