...
{{#each .}}
<li class="replyLi" data-reply_num={{reply_num}}>
<i class="fa fa-comments bg-blue"></i>
 <div class="timeline-item" >
  <span class="time">
    <i class="fa fa-clock-o"></i>{{prettifyDate regdate}}
  </span>
  <h3 class="timeline-header"><strong>{{reply_num}}</strong> -{{member_num}}</h3>
		  ...
		  $.ajax({
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <ul class="timeline">
                     <!-- timeline time label -->
                     <li class="time-label" id="repliesDiv"><span class="bg-green" style="color: white">Replies List </span></li>
                  </ul>
...
<!-- Modal -->
<div id="modifyModal" class="modal modal-primary" role="dialog">  <!--  class= fade 없앰-->
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn" id="replyModBtn">Modify</button>
