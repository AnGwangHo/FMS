...
<body>
	...
	<div>
		<div>
			member_num <input type='text' name='member_num' id='newReplyWriter'>
		</div>
		<div>
			REPLY TEXT <input type='text' name='reply_content' id='newreply_content'>
		</div>
	...
	<script>
		...
		$("#replyAddBtn").on("click", function() {
			...
			var member_num = $("#newReplyWriter").val();
		...
		$("#replies").on("click", ".replyLi button", function() {
			...
			var reply_num = reply.attr("data-reply_num");
			var reply_content = reply.text();
		...
		function getPageList(page){
		  ...
		  $.getJSON("/replies/"+bulletin_num+"/"+page , function(data){
