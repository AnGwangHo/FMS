 		...
 		<!-- FORM 종료 -->
            ...
            <div class="table-responsive">
               ...
               <div align="right" style="margin-right: 10px">
                  <button type="button" onclick="location.href='/board/removePage'" class="btn btn-danger btn3d">   
                     <span class="glyphicon glyphicon-remove"></span> 삭제 
                  </button>
                  <button type="button" onclick="location.href='/board/board_modify'" class="btn btn-primary btn3d">
                     <span class="glyphicon glyphicon-pencil"></span> 글 수정
                  </button>
                  <button type="button" onclick="location.href='/board/board_list'" class="btn btn-info btn3d">       
               ...
               <div class="col-md-12">
                  ...
                  <div class="box box-success">
                     <div class="box-header">
                        <h3 class="box-title" style="color: white">댓글등록</h3>
                     </div>
                     <div class="box-body">
                     ...
                     <!-- /.box-body -->
                     <div class="box-footer" style="margin-top: 10px; margin-bottom: 20px;">
                        <button type="button" class="btn btn-primary btn3d" id="replyAddBtn" >등록완료</button>
                     </div>
                  </div>
