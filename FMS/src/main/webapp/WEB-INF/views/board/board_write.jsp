            ...
            <div class="table-responsive">
                  ...
                  <table class="table table-bordered  table-hover ">
                     ...
                     <tr>
                        ...
                        <td><input type="text" class="form-control" name="member_id" placeholder="" value="${sessionScope.login.member_id}" readonly="readonly"></td>
               ...
               <div align="right" style="margin-right: 10px">
                  <button type="button" onclick="javascript:location.href='/board/board_list'"  class="btn btn-danger  btn3d">
