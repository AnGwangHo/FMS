...
public interface RegularstarterDao {
	...
	/** regularstarter 등록 */
	public void regularstarterAdd(int tactics_num, int member_num, int position_num, int regularstarter_half, String regularstarter_location)throws Exception;
