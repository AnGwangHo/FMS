...
public class BulletinDaoImpl implements BulletinDao {
	...
	// 파일첨부
	@Override
	public void addAttach(String bulletin_attachment) throws Exception {
		// TODO Auto-generated method stub
		session.insert(namespace + ".addAttach", bulletin_attachment);
	}

	// 파일첨부 읽기
	@Override
	public List<String> getAttach(Integer bulletin_num) throws Exception {
		return session.selectList(namespace + ".getAttach", bulletin_num);
	}
