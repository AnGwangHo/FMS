...
<header role="page-title">
    ...
    <ul>
<li>
<img src="/html/member_images/park.jpg" class="img-circle img-responsive" alt="Conxole Admin" width="170" height="150" style="float: left; margin-left: 400px; border: 8px solid black;" />
