...
public class memberController {
	...
	/** 사진 업로드를 위한 Repository*/
	private String uploadRepository;
	
	 String savePath = "/http/images/member";
...
/*	public void setUploadRepository(String uploadRepository) {
		...
		public void fileUpload(HttpServletRequest request, HttpServletResponse response) throws Exception{
		  ...
		  MultipartFile multipartFile = multipartReq.getFile("member_profile_image");
		...
		// 경로
		  ...
		  try{
		    ...
		    logger.info(multipartFile.getOriginalFilename() + "사진 업로드 완료!");
		  } catch(IOException e){
